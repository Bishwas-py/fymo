...
@pytest.mark.parametrize("plural,singular", [
    ...
    ("stories", "story"),
    ("categories", "category"),
    # es whose singular really ends in the sibilant
    ("statuses", "status"),
    ("boxes", "box"),
    ("taxes", "tax"),
    ("dishes", "dish"),
    ...
    ("canvases", "canvas"),
    ("quizzes", "quiz"),
    # ses/zes/ches stems default to restoring the silent e (the full
    # reviewer list from the round 3 audit, verbatim)
    ("courses", "course"),
    ("houses", "house"),
    ("cases", "case"),
    ("expenses", "expense"),
    ...
    ("caches", "cache"),
    ("niches", "niche"),
    # oes: strip only the s unless the noun really ends in o
    ("shoes", "shoe"),
    ("toes", "toe"),
    ("heroes", "hero"),
    ("potatoes", "potato"),
